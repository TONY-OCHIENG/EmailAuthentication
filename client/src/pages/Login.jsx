  ...
  return (
    ...
    >
        <div className='p-8'>
            ...
            text-transparent bg-clip-text'>Login to account</h2>
            <form action="" onSubmit={handleSubmit}>
                ...
                <p className='mt-6 text-xs text-gray-300 '>Don't have an Account <Link to={'/signup'} className='font-extrabold'>Click to signup</Link></p>
                <p className='mt-4 text-xs text-gray-300 font-extrabold'><Link to={'/forgot-Link'}>Forgot password?</Link></p>
            </form>
        </div>
    </motion.div>
  )
